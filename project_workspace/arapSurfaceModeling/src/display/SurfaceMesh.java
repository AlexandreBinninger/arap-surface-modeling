package display;import Jcg.geometry.*;
...
public class SurfaceMesh {
	...
	public void drawFace(Face<Point_3> f) {
		...
		Point_3 uDraw = new Point_3(u.x*zoom+incrx, u.y*zoom+incry, u.z*zoom+incrz);
		view.noStroke();
		...
		while(pEdge.getVertex()!=h.getOpposite().getVertex()) {
			...
			Point_3 vDraw = new Point_3(v.x*zoom+incrx, v.y*zoom+incry, v.z*zoom+incrz);
			Point_3 wDraw = new Point_3(w.x*zoom+incrx, w.y*zoom+incry, w.z*zoom+incrz);
